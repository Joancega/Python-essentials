...
# La principal diferencia es que las tuplas contienen valores cuyo contenido no se puede cambiar, mientras que en la lista el contenido de cada celda es modificable. Además, en cuanto a sintaxis, las listas se escribe con corchetes [], mientras que las tuplas con parentesis ().
